...
ClassImp( MonteCarloRunHeader )

MonteCarloRunHeader::MonteCarloRunHeader()
{
    reset();
}

void MonteCarloRunHeader::reset()
{
    runnumber = -1;
...
void MonteCarloRunHeader::printRunNumber()
{
    cout << runnumber << endl;
}

void MonteCarloRunHeader::printMCAz( bool iLowerLimit )
{
    if( iLowerLimit )
    {
...
void MonteCarloRunHeader::print()
{
    cout << endl;
...
double MonteCarloRunHeader::getMeanZenithAngle_Deg()
{
